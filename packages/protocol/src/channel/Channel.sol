    ...
    DeferredTokenAuthorization
{
    ...
    function sponsorWithERC20(
        ...
        nonReentrant
    {
        (uint256 tokenId, uint256 numUserCreations) = _processSponsoredToken(tokenPermission, author, signature);
    ...
    {
        _validateDeferredTokenCreation(tokenPermission, author, signature);
