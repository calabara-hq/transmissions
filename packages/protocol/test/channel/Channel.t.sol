...
import { WETH } from "../rewards/WETH.sol";
...
contract ChannelTest is Test {
  ...
  // todo - no need to test the proxy here, that should be done in the infiniteChannel tests
  // i.e. only test initialize, and in the infiniteChannel tests, test initialize behind the proxy
