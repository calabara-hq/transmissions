...
contract ChannelTokenSponsorshipTest is Test {
  ...
  function test_channelSponsorship_sponsorWithERC20() external {
    ...
    channelImpl.sponsorWithERC20(deferredToken, author, signature, minter, 1, referral, "");
  ...
  function test_channelSponsorship_allowNonLinearExecution() public {
    ...
    channelImpl.sponsorWithETH{ value: 0.000777 ether }(deferredToken2, author, signature2, minter, 1, referral, "");

    channelImpl.sponsorWithETH{ value: 0.000777 ether }(deferredToken1, author, signature1, minter, 1, referral, "");
    vm.stopPrank();
  }
