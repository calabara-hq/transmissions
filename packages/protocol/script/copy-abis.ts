...
// https://github.com/ourzora/zora-protocol/blob/main/packages/1155-contracts/script/bundle-abis.ts
// and
// https://github.com/wagmi-dev/wagmi/blob/main/packages/cli/src/plugins/foundry.ts
...
export const readContracts = async ({
  ...
  async function getContract(artifactPath: string) {
    ...
    return {
      abi: artifact.abi,
      address: (deployments as Record<string, ContractConfig["address"]>)[getContractName(artifactPath, false)],
